...
-- BusinessPartner - Business Unit relationship table (many-to-many)
...
CREATE UNIQUE INDEX uq_service_category
...
CREATE UNIQUE INDEX uq_service
...
-- service_provider_service: refers what services are offered by a service provider in a specific business unit
...
-- service_provider_schedule: defining weekly schedules for service providers, with specific time slots and durations for appointments
