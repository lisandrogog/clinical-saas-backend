...
- `domain_map.md`: Mapa de Dominios y Responsabilidades.
- `glossary.md`: Diccionario de datos.
- `index.md`: indice de archivos de la carpeta .context/.
- `specs.md`: Especificaciones Técnicas (Specs).
- `style_guide.md`: Manual de Estilo de Código.
